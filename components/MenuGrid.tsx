...
const MenuGrid: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'grill-specials', label: 'Grill Specials' },
    { id: 'burgers', label: 'Gourmet Burgers' },
    { id: 'pizzas', label: 'Pizzas' },
    { id: 'fish-chips', label: 'Fish & Chips' },
    { id: 'chicken-sides', label: 'Bites & Wings' },
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-24 p-12 bg-neutral-900 text-white rounded-[3rem] shadow-2xl border border-neutral-800 flex flex-col md:flex-row gap-12 justify-between items-center">
          <div className="max-w-md">
            <h4 className="text-2xl font-black uppercase mb-4 tracking-tight">CRAVING EXTRAS?</h4>
            <p className="text-neutral-400 text-sm leading-relaxed italic">
              Add extra Doner meat, Cheese Sauce, or Jalapeños to any order. Upgrade any burger or kebab to a meal with chips and a drink for +£3.45!
            </p>
          </div>
