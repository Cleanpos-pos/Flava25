          ...
          <div className="order-2 md:order-1 relative">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-lg text-neutral-600 leading-relaxed">
                <p>
                  At Flava25, we are committed to providing the best food experience in your own home or on the go. We don't just do fast food; we do <span className="text-green-600 font-bold underline decoration-2 underline-offset-4">fresh food</span>.
                </p>
                <p>
                  From our signature 100% Flava25 patties to our flame-grilled peri peri chicken, every bite is crafted for quality. Our kitchen is the heart of Cradley Heath, where tradition meets modern urban taste.
                </p>
                <div className="flex items-center gap-6 pt-4">
                  <div className="text-center">
                    <div className="text-3xl font-black text-neutral-900">100%</div>
                    <div className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Beef</div>
                  </div>
