...
const ContactInfo: React.FC = () => {
  ...
  // Updated map embed for 175 Halesowen Rd, Cradley Heath B64 6HE
  const mapUrl = `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2430.222303030303!2d-2.0628!3d52.4705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48709088737335d5%3A0xc66c04f98242c3c9!2s175%20Halesowen%20Rd%2C%20Old%20Hill%2C%20Cradley%20Heath%20B64%206HE!5e0!3m2!1sen!2suk!4v1710345678901!5m2!1sen!2suk`;
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-16">
          <div className="space-y-10">
            <div>
              <h2 className="text-4xl font-black mb-6 tracking-tight uppercase">FIND US IN <span className="text-orange-500">CRADLEY HEATH</span></h2>
